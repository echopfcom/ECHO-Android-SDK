...
public class ECHORecordObject extends ECHOContentsObject<ECHORecordObject>
	...
	/**
	 * {@.en Constructs a new ECHORecordObject based on an existing one on the ECHO server.}
	 * {@.ja 既存のレコードをオブジェクトとして生成します。}
	 * 
	 * @param instanceId
	...
	/**
	 * Constructs a new ECHORecordObject based on an existing one on the ECHO server.
	 ...
	 * @param data : a copying record object by JSONObject
	 */

...
public class ECHOEntryObject extends ECHOContentsObject
	...
	/**
	 * Constructs a new ECHOEntryObject based on an existing one on the ECHO server.
	 ...
	 * @param data : a copying entry object by JSONObject
	 */

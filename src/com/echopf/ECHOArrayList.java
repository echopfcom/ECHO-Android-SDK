...
/**
 * {@.en Composes an ArrayList with paginate data.}
 * {@.ja リストデータのページ送り情報が付属したArrayListを構成します。}
 */
public class ECHOArrayList<S extends ECHODataObject<S>> extends ArrayList<S> {
	...
	/**
	 * Constructs a new ECHOArrayList.
	 * 
	 * @param data a copying paginate data by JSONObject.
	 * @throws ECHOException 
	 */
	protected ECHOArrayList(JSONObject data) throws ECHOException {
		super();

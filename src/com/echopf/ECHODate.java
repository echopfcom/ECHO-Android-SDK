...
public class ECHODate extends Date {
	...
	/**
	 * {@.en Constructs a new ECHODate with a date string in the ECHO API.}
	 * {@.ja ECHO APIの仕様に準拠した文字列形式の日時から、日時オブジェクトを生成します。}
	 * @param s a date string in the ECHO API (e.g. "2015-02-20 00:00:00")
	 */
	...
	/**
	 * {@.en Converts this object to an valid date string in the ECHO API.}
	 * {@.ja ECHO APIの仕様に準拠した文字列形式の日時へ変換します。}
